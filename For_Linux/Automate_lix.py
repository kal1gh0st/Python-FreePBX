...
import urllib, winsound (possible unsupported)
impoet urllib3 
import json
import schedule (change and install schedule cron)
import crontjob
import requests


'''
La chiamata di questo script dipende dall'attività configurata su "Utilità di pianificazione" definita "FreePBX-CallsCheck".
Ogni giorno alle 9:30 eseguirà lo script e verrà interrotta alle ore 18 dal task "Stop-FreePBX".
'''
