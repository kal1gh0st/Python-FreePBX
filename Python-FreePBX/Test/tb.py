...
def telegram_bot_sendtext(bot_message):
    ...
    bot_token = '1099352917:AAH7qrpH-QJ-N1vV1iLA2OZOl32ck7Mps4M'
    

    params ={
        #"chat_id":'-371859866',
        "chat_id":'-1001358047382',
        "text":bot_message,
        "parse_mode":"HTML"
    }
...
while True:
    ...
    telegram_bot_sendtext("<b>Test delle {}</b>".format(clock.strftime("%H:%M")))
    time.sleep(320)
